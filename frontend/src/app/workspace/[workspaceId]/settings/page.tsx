...
export default function WorkspaceSettingsPage() {
  ...
  const { currentWorkspace, selectWorkspace, fetchWorkspaces } = useWorkspaceStore();
    ...
    try {
      ...
      setTimeout(async () => {
        if (currentWorkspace) {
          ...
          setSuccess('Workspace details successfully saved and synchronized across active channels.');
        }
        setLoading(false);
      }, 800);
    } catch (err) {
  ...
  const handleGenerateToken = () => {
    ...
    setSuccess('New invite token generated. Share this token with your teammates to allow direct workspace registration.');
  };
  ...
  const handleDeleteWorkspace = async () => {
    ...
    if (confirm(`CRITICAL WARNING: Are you sure you want to delete workspace "${currentWorkspace.name}"? This action is permanent and deletes all databases records, projects cards, subtasks checklists, and documents!`)) {
      setLoading(true);
      // Simulate deletion
      setTimeout(() => {
  ...
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-8">
      ...
      <div>
        ...
        <p className="text-xs text-zinc-400 font-light mt-1">Manage overall tenant policies, rename workspaces, and generate invite tokens.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 flex flex-col gap-6">
          ...
          <div className="glass-panel p-6 rounded-2xl border-white/5 relative overflow-hidden">
            ...
            <p className="text-xs text-zinc-400 font-light mb-6">Create tokens to bypass individual email invite rules during client registration.</p>
        ...
        <div className="flex flex-col gap-6">
          <div className="glass-panel p-6 rounded-2xl border-red-500/10 flex flex-col gap-4 relative overflow-hidden h-fit bg-red-500/[0.01]">
            ...
            <p className="text-xs text-zinc-400 leading-relaxed font-light">
              Purging the workspace deletes all projects, tasks history, comments, Wikis, files, and members lists permanently.
            </p>
