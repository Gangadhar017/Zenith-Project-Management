...
export default function DashboardLayout({ children }) {
  ...
  const handleClerkUpdateProfile = async (e) => {
    ...
    try {
      ...
      setClerkSuccess(
        "Profile successfully synchronized with Clerk auth layers!",
      );
    } catch (err) {
        ...
        <div>
          ...
          <div className="p-4 flex flex-col gap-1">
            ...
            <Link
              ...
              className={
                pathname.includes("/wiki") ? activeLinkClass : inactiveLinkClass
              }
            >
            ...
            <Link
              ...
              className={
                pathname.includes("/team") ? activeLinkClass : inactiveLinkClass
              }
            >
                          ...
                          {matchedProjects.map((p) => (
                            <button
                              ...
                              onClick={async () => {
                                ...
                                router.push(
                                  `/workspace/${currentWorkspace?.id}/project/${p.id}`,
                                );
                              }}
                            ...
                            >
                              ...
                              <span className="text-[8px] bg-primary/10 text-primary border border-primary/20 px-1.5 py-0.2 rounded font-bold uppercase scale-90">
                                BOARD
                              </span>
                            </button>
                          ))}
                          ...
                          {matchedTasks.map((t) => (
                            <button
                              ...
                              onClick={async () => {
                                ...
                                setGlobalSearchQuery("");
                                router.push(
                                  `/workspace/${currentWorkspace?.id}/project/${t.projectId}`,
                                );
                              }}
                              className="w-full text-left px-2 py-1.5 rounded-lg hover:bg-white/5 text-xs text-foreground font-semibold flex items-center justify-between group transition"
                            >
                              ...
                              <span className="text-[8px] bg-secondary/10 text-secondary border border-secondary/20 px-1.5 py-0.2 rounded font-bold uppercase scale-90">
                                {t.status}
                              </span>
                            </button>
                          ))}
            ...
            <div className="w-64 bg-zinc-50/50 dark:bg-zinc-900/30 border-r border-card-border p-6 flex flex-col justify-between shrink-0">
              ...
              <div className="flex flex-col gap-1 border-t border-card-border pt-4">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[8px] bg-primary/15 text-primary border border-primary/30 px-1.5 py-0.5 rounded font-bold uppercase tracking-wider">
                    DEV MODE
                  </span>
                </div>
                <span className="text-[9px] text-zinc-500 font-light">
                  Secured by Clerk developer endpoints.
                </span>
              </div>
            </div>
              ...
              {clerkTab === "profile" ? (
                <div className="flex flex-col gap-6">
                  <div>
                    ...
                    <p className="text-xs text-zinc-500 mt-1 font-light">
                      Configure your collaborative credentials and custom
                      account seeds.
                    </p>
                  </div>

                  <form
                    onSubmit={handleClerkUpdateProfile}
                    ...
                    <div className="flex items-center gap-4 bg-card border border-card-border p-4 rounded-xl">
                      ...
                      <div className="flex-1 flex flex-col gap-1.5">
                        ...
                        <span className="text-[9px] text-zinc-500 italic">
                          Type to dynamically randomize your customized card.
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] font-bold text-zinc-500 tracking-wider">
                      EMAIL ADDRESSES
                    </label>
                    <div className="flex justify-between items-center bg-card border border-card-border p-3 rounded-xl">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] bg-green-500/10 text-green-500 border border-green-500/20 px-1.5 py-0.5 rounded-full font-semibold">
                          Primary
                        </span>
                      </div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex justify-between items-center bg-card border border-card-border p-3 rounded-xl">
                      <div className="flex items-center gap-2">
                        <div className="h-5 w-5 bg-red-500/10 text-red-500 rounded-full flex items-center justify-center font-bold text-[10px] shrink-0 border border-red-500/20">
                          G
                        </div>
                        <span className="text-xs font-medium text-foreground">
                          Google
                ...
                <div className="flex flex-col gap-6">
                  <div>
                    ...
                    <p className="text-xs text-zinc-500 mt-1 font-light">
                      Modify your secure credentials stored inside the
                      PostgreSQL tenant registry.
                    </p>
                  </div>

                  <form
                    onSubmit={handleClerkUpdatePassword}
                  ...
                  >
                    <div className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setClerkCurrentPassword(e.target.value)
                        }
                      />
                    </div>
      ...
      {showWorkspaceModal && (
        <div className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-md glass-panel p-6 rounded-2xl border border-card-border shadow-2xl relative">
            <button
              className="absolute top-4 right-4 text-zinc-500 hover:text-foreground"
            ...
            <p className="text-xs text-zinc-400 mb-6 font-light">
              Group your projects under a central tenant workspace hub.
            </p>
      ...
      {showProjectModal && (
        <div className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-md glass-panel p-6 rounded-2xl border border-card-border shadow-2xl relative">
            ...
            <p className="text-xs text-zinc-400 mb-6 font-light">
              Add a brand new agile scrum or task board to your active space.
            </p>
