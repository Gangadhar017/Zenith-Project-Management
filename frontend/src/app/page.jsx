    ...
    <div className="min-h-screen bg-zenith-dark text-foreground flex flex-col relative overflow-hidden">
      ...
      <header className="sticky top-0 z-50 glass-panel border-b border-white/5 py-4 px-6 md:px-12 flex justify-between items-center">
        ...
        <nav className="hidden md:flex gap-8 text-sm text-zinc-400 font-medium">
          ...
          <a href="#documentation" className="hover:text-primary transition">
            Docs
          </a>
        </nav>
      ...
      <section className="flex-1 flex flex-col justify-center items-center px-6 text-center pt-20 pb-16 z-10">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-semibold tracking-wide text-primary shadow-sm mb-6 animate-pulse">
          <Sparkles className="h-3.5 w-3.5" /> Next-Generation Project
          Management Platform
        </div>
        ...
        <p className="text-lg md:text-xl text-zinc-400 max-w-2xl font-light leading-relaxed mb-10">
          Streamline your team sprints, track tasks in real-time, and leverage
          context-aware intelligence to ship code faster.
        </p>
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="rounded-xl bg-white/[0.02] border border-white/5 p-4 flex flex-col gap-3">
                <div className="flex items-center justify-between border-b border-white/5 pb-2">
                  ...
                  <span className="h-5 w-5 bg-white/5 rounded text-xs flex items-center justify-center">
                    3
                  </span>
                </div>
              ...
              <div className="rounded-xl bg-white/[0.02] border border-white/5 p-4 flex flex-col gap-3">
                <div className="flex items-center justify-between border-b border-white/5 pb-2">
                  ...
                  <span className="h-5 w-5 bg-primary/10 text-primary rounded text-xs flex items-center justify-center">
                    1
                  </span>
                </div>
                <div className="rounded-lg bg-primary/5 border border-primary/20 p-3 flex flex-col gap-2 relative overflow-hidden">
                  ...
                  <div className="flex justify-between items-center pt-2">
                    ...
                    <div className="flex -space-x-1.5">
                      <span className="h-4 w-4 rounded-full bg-primary flex items-center justify-center text-[8px] font-bold text-white">
                        A
                      </span>
                      <span className="h-4 w-4 rounded-full bg-zinc-700" />
                    </div>
      ...
      <section id="features" className="py-24 px-6 md:px-12 z-10">
        <div className="max-w-6xl mx-auto text-center mb-16">
          ...
          <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
            Everything your team needs to plan, track, and ship code faster,
            consolidated into one high-performance interface.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glass-card p-8 rounded-2xl flex flex-col gap-4">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              Drag and drop task cards with zero delay. Syncs instantly across
              all connected screens via our Socket.io presence engine.
            </p>
          </div>
          ...
          <div className="glass-card p-8 rounded-2xl flex flex-col gap-4">
            ...
            <h3 className="text-xl font-bold text-white">
              Agile Project Analytics
            </h3>
            <p className="text-zinc-400 text-sm leading-relaxed">
              Beautiful charts depicting burn-down rates, historical team
              velocity, time trackers, and project health scores.
            </p>
          </div>
          ...
          <div className="glass-card p-8 rounded-2xl flex flex-col gap-4">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              A context-aware AI chatbot sidebar. Ask complex questions about
              backlog status, user assignments, or document wikis.
            </p>
          </div>
        </div>
      </section>
      ...
      <section
        id="ai"
        className="py-24 px-6 md:px-12 bg-white/[0.01] border-y border-white/5 z-10 relative"
      >
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative">
          <div className="flex-1 text-left flex flex-col gap-6">
            ...
            <p className="text-zinc-400 text-base leading-relaxed">
              Why use simple task managers when you can have a collaborative
              teammate? Zenith is armed with Gemini AI models that analyze
              real-time project metrics, estimate release deadlines, and resolve
          ...
          <div className="flex-1 w-full grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="glass-card p-6 rounded-xl flex flex-col gap-2">
              ...
              <p className="text-sm font-semibold text-white">
                AI predicts: 2 days delay threat
              </p>
              <p className="text-xs text-zinc-400 leading-normal">
                Capacity warning on user assignment. Shift pending Database
                migration checks forward.
              </p>
            </div>
            <div className="glass-card p-6 rounded-xl flex flex-col gap-2 border-primary/30">
              ...
              <p className="text-xs text-zinc-400 italic">
                "Yesterday: Finalized Express routing middlewares. Today:
                Launching Socket.io room joins."
              </p>
            </div>
            <div className="glass-card p-6 rounded-xl flex flex-col gap-2 col-span-1 sm:col-span-2">
              <span className="text-xs font-bold text-purple-400 flex items-center gap-1">
                <Bot className="h-3 w-3" /> GPT / Gemini Workspace Chat
              </span>
              <p className="text-xs text-zinc-400 italic">
                "Who is currently working on database migration schemas?"
              </p>
              <p className="text-xs text-white bg-white/5 p-2 rounded-lg mt-1 border border-white/5">
                "Currently, **Gangadhar** is assigned to the database branch
                with 2 subtasks pending."
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="py-24 px-6 md:px-12 z-10">
        <div className="max-w-6xl mx-auto text-center mb-16">
          ...
          <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
            Get started for free, then scale up features seamlessly as your
            product team completes sprints.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="glass-panel p-8 rounded-2xl flex flex-col justify-between border-white/5 relative">
            <div>
              ...
              <p className="text-zinc-400 text-sm mb-6">
                Perfect for solo developers and quick side integrations.
              </p>
              ...
              <ul className="flex flex-col gap-4 text-sm text-zinc-300 mb-8">
                <li className="flex items-center gap-3">
                  <ShieldCheck className="h-4 w-4 text-primary" /> 1 Active
                  Workspace
                </li>
                <li className="flex items-center gap-3">
                  <ShieldCheck className="h-4 w-4 text-primary" /> Max 3 Active
                  Projects
                </li>
                <li className="flex items-center gap-3">
                  <ShieldCheck className="h-4 w-4 text-primary" /> Realtime
                  Sockets Kanban board
                </li>
                <li className="flex items-center gap-3 text-zinc-500">
                  <ShieldCheck className="h-4 w-4 text-zinc-500" /> Advanced AI
                  analytics suite
                </li>
              </ul>
            </div>
          ...
          <div className="glass-panel p-8 rounded-2xl flex flex-col justify-between border-primary/20 relative overflow-hidden">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm mb-6">
                Designed for scale-ups and fast-paced high-velocity tech teams.
              </p>
              <div className="flex items-baseline gap-1 mb-8">
              ...
              <ul className="flex flex-col gap-4 text-sm text-zinc-300 mb-8">
                <li className="flex items-center gap-3">
                  <ShieldCheck className="h-4 w-4 text-primary" /> Unlimited
                  Active Workspaces
                </li>
                <li className="flex items-center gap-3">
                  <ShieldCheck className="h-4 w-4 text-primary" /> Unlimited
                ...
                <li className="flex items-center gap-3">
                  <ShieldCheck className="h-4 w-4 text-primary" /> Full
                  real-time synchronization
                </li>
                <li className="flex items-center gap-3">
                  <ShieldCheck className="h-4 w-4 text-primary" /> **11 Gemini
                  AI Suite Modules** included
                </li>
                <li className="flex items-center gap-3">
                  <ShieldCheck className="h-4 w-4 text-primary" /> Advanced
                  Gantt charts & wikis
                </li>
              </ul>
            </div>
      ...
      <footer className="glass-panel border-t border-white/5 py-12 px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-6 z-10 text-sm text-zinc-500">
        ...
        <p>
          © 2026 Zenith. Designed for Silicon Valley high-performance dev teams.
        </p>
